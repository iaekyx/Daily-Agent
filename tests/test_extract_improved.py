...
# Calculate column bounds based on caption
# Standard 2-column detection
...
for blk in text_blocks:
    if blk[3] < caption_y0 - 5:
        ...
        if clip_x0 - 20 <= center_x <= clip_x1 + 20:
...
pix.save(TEST_DIR / "test_improved.png")
print("Saved test_improved.png")
